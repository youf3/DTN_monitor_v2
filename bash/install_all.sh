...
function f_centos_install(){
    ...
    sudo yum install -y wget bzip2 make gcc iperf3;
    ...
    sudo chmod 755 /opt/nuttcp-8.1.4/nuttcp-8.1.4
    sudo chmod 755 /opt/nuttcp-8.1.4
    sudo chown -R root /opt/nuttcp-8.1.4 
    ...
    ## install jupyterhub
    sudo yum -y install yum-utils python-software-properties
    sudo yum -y groupinstall development
    sudo yum -y install https://centos7.iuscommunity.org/ius-release.rpm
    sudo yum -y install https://kojipkgs.fedoraproject.org//packages/http-parser/2.7.1/3.el7/x86_64/http-parser-2.7.1-3.el7.x86_64.rpm ; # to fix nodejs
    sudo yum -y install git python34-devel libzmq3-dev npm nodejs-legacy  pciutils libfreetype6-dev python34-pip python34-devel ;
...
function f_ubuntu_install(){
    #  nuttcp
    sudo apt-get install -y python3 python-software-properties software-properties-common openbsd-inetd wget bzip2 make gcc iperf3;
    cd /tmp;
    wget http://nuttcp.net/nuttcp/nuttcp-8.1.4.tar.bz2;
    bzip2 -d nuttcp-8.1.4.tar.bz2;
    tar -xvf nuttcp-8.1.4.tar;
    ...
    sudo apt-get -y install python3 python-software-properties software-properties-common python3-pip git python3-dev python-dev libzmq3-dev npm nodejs-legacy python3-matplotlib pciutils libfreetype6-dev;
    sudo npm install -g configurable-http-proxy;
