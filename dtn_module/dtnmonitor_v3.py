...
class DTNMonitor:
    ...
    def draw_graph(self):
        ...
        m_graph_p = -self.max_graph_point
        while self.running:
            ...
            netarr = numpy.array(self.network_monitor_list[m_graph_p:])
            netrec = numpy.array(self.network_rec_list[m_graph_p:])
            netsnt = numpy.array(self.network_snt_list[m_graph_p:])
            diskarr = numpy.array(self.diskio_monitor_list[m_graph_p:])
            diskw = numpy.array(self.diskio_write_list[m_graph_p:])
            diskr = numpy.array(self.diskio_read_list[m_graph_p:])
            cpuarr = numpy.array(self.cup_monitor_list[m_graph_p:])
            memarr = numpy.array(self.mem_monitor_list[m_graph_p:])
